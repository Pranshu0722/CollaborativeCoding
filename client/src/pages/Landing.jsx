...
const GITHUB_URL = 'https://github.com/Pranshu0722/CollaborativeCoding'
  ...
  return (
    <div className="w-full font-mono text-sm">
      ...
      <div className="flex items-center gap-1.5 text-xs">
        ...
        <span className="text-zinc-400">Pranshu is typing…</span>
      </div>
    </div>
  )
}
  ...
  return (
    <div className="w-full font-mono text-xs">
      ...
      <div className="feature-fade-in mt-1.5 text-xs flex items-center gap-1.5 text-zinc-500">
        ...
        <span>Run by Pranshu · 142ms · exit 0</span>
      </div>
    </div>
  )
}
      ...
      <div className="px-4 py-4 font-mono text-sm leading-relaxed">
        ...
        <div className="flex">
          ...
          <span>
            ...
            <span className="text-zinc-400">))</span>
            {/* Pranshu's cursor — emerald, position-relative so the flag stacks above */}
      ...
      <div className="border-t border-zinc-800 bg-zinc-900/50">
        <div className="px-4 py-2 border-b border-zinc-800 flex items-center justify-between text-xs">
          ...
          <span className="text-zinc-500">
            Run by <span className="text-zinc-300">Pranshu</span> · 142ms · exit 0
          </span>
        </div>
